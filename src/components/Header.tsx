...
export default function Header() {
  ...
  return (
    <header className='flex justify-between gap-4 sm:gap-20 p-2 px-4 relative md:px-20 bg-red-600 items-center shadow-redShade'>
          ...
          <button className='flex p-1 px-6 text-4xl font-semibold text-gray-50 hover:bg-red-700 duration-300 rounded-full'>
            Home
            
          </button>

          <Link href={'https://www.nytimes.com/'} target={'_blank'} className='flex cel:w-32 p-2 text-center text-xs realive self-end font-semibold text-gray-50 hover:underline duration-300 rounded-full'>
